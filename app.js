...
const imgHover = (e) => {
  ...
  if (name === 'one'){
    document.querySelector('#one').style.width = '110%'
  }else if (name === 'two'){
    document.querySelector('#two').style.width = '110%'
  }else if (name === 'three'){
    document.querySelector('#three').style.width = '110%'
  }else if (name === 'four'){
    document.querySelector('#four').style.width = '110%'
  }else if (name === 'five'){
    document.querySelector('#five').style.width = '110%'
  }else if (name === 'six'){
    document.querySelector('#six').style.width = '110%'
  }else if (name === 'seven'){
    document.querySelector('#seven').style.width = '110%'
  }else if (name === 'eight'){
    document.querySelector('#eight').style.width = '110%'
  }else if (name === 'nine'){
    document.querySelector('#nine').style.width = '110%'
  }else if (name === 'ten'){
    document.querySelector('#ten').style.width = '110%'
  }
}
  const imgDown = (e) => {
    let name = e.target.id
